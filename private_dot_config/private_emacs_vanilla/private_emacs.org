...
*** Python
 ...
 Check out [[https://emacs-lsp.github.io/lsp-pyright/][the =pyright= configuration]] in the =lsp-mode= documentation for more details.

=pyright= is the current "best default" for most projects: faster, stronger type analysis, great multi-root support, and actively maintained.
...
#+begin_src sh :tangle no
  ...
  npm i -g pyright (or pip install pyright if you prefer the Python wheel)
