...
Ergonomic window navigation with =M-h/j/k/l= (Option + vim keys). This overrides =M-h= (mark-paragraph) which is rarely used and still accessible via =M-x mark-paragraph=.
